  ...
  <div class="breadcrumbs">
    <div class="container">
      <div class="inner">
        ...
        <a title="Quay lại trang chủ" href="/">Trang chủ</a><i class="fa fa-angle-right" aria-hidden="true"></i>${cateid.name}
      </div>
    </div>
  </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-9 col-md-8 col-sm-12 col-xs-12">
          <div class="content-left">
            ...
            <div class="body-new">
              <div class="list-news-horizontal">
                <div class="item-news">

                  <c:forEach items="${post}" var="pl">
                    <div class="item_wrap_blog">
                      <div class="row">
                        <div class="col-xs-12 col-sm-4 col-lg-4">
                          <div class="blog-img">
                            <a href="${pageContext.request.contextPath}/blogs/details/${pl.id}">
                              <img src="${pageContext.request.contextPath}/resources/images/${pl.image}" style="max-width:100%;" class="img-responsive" alt="images">
                            </a>
                          </div>
                        </div>
                        <div class="col-xs-12 col-sm-8 col-lg-8">
                          <div class="content__">
                            <h3>
                              <a href="${pageContext.request.contextPath}/blogs/details/${pl.id}">${pl.name}</a>
                            </h3>
                            <p> 
                              ${pl.note}
                            </p>
                  ...
                  <div class="pagination text-center">
                    <mytag:PaginationTaglib max="12" offset="${offset}" count="${count}" uri="${pageContext.request.contextPath}/blogs/${ids}" next="&raquo;" previous="&laquo;"/>
                  </div>
                </div>
              </div>
            </div>
