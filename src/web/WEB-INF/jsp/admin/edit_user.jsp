                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-12 col-md-4">
                        <div class="visible-status">
                          ...
                          <div class="show-st">
                            <input type="radio" name="role" value="1" <c:if test="${user.role == true}">checked</c:if>> <span class="hideshow">SuperAdmin</span>
                            </div>
                            <div class="show-st">
                              <input type="radio" name="role" value="0" <c:if test="${user.role == false}">checked</c:if>> <span class="hideshow">Admin</span>
                            </div>
                        </div>
                      </div>
                    </div>
