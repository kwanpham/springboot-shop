          ...
          <div class="page-content">
            ...
            <div class="internew-content">
              ...
              <div class="curd" style=" margin-right:70px;  width:100%;">
                <f:form action="${url}" modelAttribute="categorypost" method="post">
                  <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                    <div class="breadcrumb">
                      <div class="breadcrumb-left">
                        <i class="menu-icon fa fa-tags" aria-hidden="true"></i>
                        <a href="index" class="title_bread"> Danh mục tin tức</a>
                        <span style="color:#ccc;margin:0px 15px;font-size:20px;"> /</span>
                        <c:choose>
                          <c:when test="${url != 'add'}">
                            <span class="title_bread">  Sửa nhóm tin tức</span>
                          </c:when>
                          <c:otherwise>
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-12 col-md-4">
                        <div class="visible-status">
                          ...
                          <div class="check-st">
                            <div class="show-st">
                              <input type="radio" path="status" name="status" value="1" <c:if test="${categorypost.status == true}">checked</c:if>> <span class="hideshow">Hiện</span>
                              </div>
                              <div class="show-st">
                                <input type="radio" name="status" value="0" <c:if test="${categorypost.status == false}">checked</c:if>> <span class="hideshow">Ẩn</span>
                              </div>
                            </div>
                          </div>
                        </div>
