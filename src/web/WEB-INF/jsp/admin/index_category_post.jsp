                    ...
                    <div class="page-content">
                        ...
                        <div class="internew-content">
                            ...
                            <table class="table table-responsive tbl_business" id="example">
                                ...
                                <tbody>
                                    <c:forEach items="${listCatepost}" var="c">
                                        <tr class="text-center">
                                            ...
                                            <td class="text-center">
                                                <a class="view_sua btn btn-xs btn-success" href="edit?catepotsId=${c.id}">Sửa</a>
                                                <a class="btn_confirm btn btn-xs btn-danger" href="delete?catepotsId=${c.id}" >Xóa</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
