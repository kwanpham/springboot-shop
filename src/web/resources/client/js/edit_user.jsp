                    ...
                    <div class="page-content">
                        ...
                        <div class="internew-content">
                            ...
                            <div class="curd" style=" margin-right:70px;  width:100%;">
                                <f:form action="${url}" modelAttribute="user" method="post">
                                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                                        <div class="breadcrumb">
                                            <div class="breadcrumb-left">
                                                ...
                                                <span class="title_bread"> ${user.fullname}</span>
                                            </div>
                                            <div class="breadcrumb-add">
                                                <a class="btn btn-default" href="admin/user">Hủy</a>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-md-8">
                                                <div class="editcreate">
                                                    <div class="form-group">
                                                        ...
                                                        <f:input class="form-control" path="fullname" id="name" name="name" type="text"/>
                                                    </div>
                                                </div>
                                                    <div class="editcreate">
                                                    <div class="form-group">
                                                        ...
                                                        <f:input type="hidden" path="id"/>
                                                        <f:input class="form-control" path="email" id="name" name="name" type="text"/>
                                                    </div>
                                                </div>
                                                 <div class="editcreate">
                                                    <div class="form-group">
                                                        ...
                                                        <f:input type="hidden" path="id"/>
                                                        <f:input class="form-control" path="password" id="name" name="name" type="text"/>
                                                    </div>
                                                </div> 
                                            ...
                                            <div class="col-xs-12 col-md-4">
                                                <div class="visible-status">
                                                    ...
                                                    <div class="check-st">
                                                        <div class="show-st">
                                                            <input type="radio" path="status" name="status" value="1" <c:if test="${user.role == true}">checked</c:if>> <span class="hideshow">Hiện</span>
                                                        </div>
                                                        <div class="show-st">
                                                            <input type="radio" name="status" value="0" <c:if test="${user.role == false}">checked</c:if>> <span class="hideshow">Ẩn</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="des-product-info-images" id="files1">
                                                    <div class="row">
                                                        <div class="col-xs-12">
                                                            ...
                                                            <div class="jiuos">
                                                                <img src="<c:url value="${user.image}"/>" style="width: 130px;"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div id="showme">
